...
--use-amp --batch-size 512 --start-lr 7e-4 --num-epochs 100 --optimizer ranger \
--num-workers 8 --fetch-step 1. --data-split-num 20 \
--network-config networks/stage3/example_GloParT3_forScouting_export.py \
--data-train \
t_h2p:./datasets/v10_ul_train_scout_hadded/BulkGravitonToHHTo4QGluLTau_MX-600to6000_MH-15to650.root \
t_hpm2p:./datasets/v10_ul_train_scout_hadded/H3ToHpHmTo4Q_MX-600to6000_MH-15to650.root \
t_qcd_170to300:./datasets/v10_ul_train_scout_hadded/QCD_PT-170to300_TuneCP5_13p6TeV_pythia8.root \
t_qcd_300to470:./datasets/v10_ul_train_scout_hadded/QCD_PT-300to470_TuneCP5_13p6TeV_pythia8.root \
t_qcd_470to600:./datasets/v10_ul_train_scout_hadded/QCD_PT-470to600_TuneCP5_13p6TeV_pythia8.root \
t_qcd_600to800:./datasets/v10_ul_train_scout_hadded/QCD_PT-600to800_TuneCP5_13p6TeV_pythia8.root \
t_qcd_800to1000:./datasets/v10_ul_train_scout_hadded/QCD_PT-800to1000_TuneCP5_13p6TeV_pythia8.root \
t_qcd_1000to1400:./datasets/v10_ul_train_scout_hadded/QCD_PT-1000to1400_TuneCP5_13p6TeV_pythia8.root \
t_qcd_1400to1800:./datasets/v10_ul_train_scout_hadded/QCD_PT-1400to1800_TuneCP5_13p6TeV_pythia8.root \
t_qcd_1800to2400:./datasets/v10_ul_train_scout_hadded/QCD_PT-1800to2400_TuneCP5_13p6TeV_pythia8.root \
t_qcd_2400to3200:./datasets/v10_ul_train_scout_hadded/QCD_PT-2400to3200_TuneCP5_13p6TeV_pythia8.root \
t_qcd_3200toInf:./datasets/v10_ul_train_scout_hadded/QCD_PT-3200toInf_TuneCP5_13p6TeV_pythia8.root \
--data-test \
qcdlo:./datasets/v10_ul_train_scout_hadded/test/QCD_PT-Low_TuneCP5_13p6TeV_pythia8.root \
qcdhi:./datasets/v10_ul_train_scout_hadded/test/QCD_PT-High_TuneCP5_13p6TeV_pythia8.root \
h2phi:./datasets/v10_ul_train_scout_hadded/test/BulkGravitonToHHTo4QGluLTau_MH-125_HighPt.root \
h2plo:./datasets/v10_ul_train_scout_hadded/test/BulkGravitonToHHTo4QGluLTau_MH-125_LowPt.root \
hpm2phi:./datasets/v10_ul_train_scout_hadded/test/H3ToHpHmTo4Q_MH-80_HighPt.root \
hpm2plo:./datasets/v10_ul_train_scout_hadded/test/H3ToHpHmTo4Q_MH-80_LowPt.root \
--samples-per-epoch $((15000 * 512 / $NGPUS)) --samples-per-epoch-val $((1000 * 512)) \
--data-config ${config} \
--model-prefix model/${PREFIX}/net \
--predict-output predict/$PREFIX/pred.root "
