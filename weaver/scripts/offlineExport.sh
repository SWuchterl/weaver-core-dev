...
--use-amp --batch-size 512 --start-lr 7e-4 --num-epochs 100 --optimizer ranger \
--num-workers 8 --fetch-step 1. --data-split-num 20 \
--network-config networks/stage3/example_GloParT3_exporter_final.py  \
--data-train \
t_h2p:./datasets/v10_ul_train_v2/BulkGravitonToHHTo4A_MX-600to6000_MH-15to250/dnnTuples_8992047-0.root \
--data-test \
qcdlo:./datasets/v10_ul_train_v2/inferv2/GluGluToBulkGravitonToHHTo4QGluLTau_M-1000_narrow/dnnTuples_8992040-0.root \
--samples-per-epoch $((15000 * 512 / $NGPUS)) --samples-per-epoch-val $((1000 * 512)) \
--data-config ${config} \
--model-prefix model/${PREFIX}/net \
--predict-output predict/$PREFIX/pred.root "
