...
def get_model(data_config, **kwargs):
    ...
    cfg = dict(
        ...
        # embed_dims=[128, 128, 128], v1-3
        embed_dims=[192, 192, 192], #v4
    ...
    print ('Using ParticleTransformerTagger as the model architecture')
    # print ('pf input dim: %d, sv input dim: %d, lt input dim: %d, lepton input dim: %d' % (cfg['pf_input_dim'], cfg['sv_input_dim'], cfg['lt_input_dim'], cfg['lepton_input_dim']))
